...
### 1) Courts increasingly seem to care about lawful sourcing, piracy, and market harm
...
### 2) Even the aggressive AI-song generators are moving toward industry accommodation
...
### 3) Google is still pushing AI music into mainstream workflow surfaces
...
- Google said the feature is rolling into the **Gemini app** and broader workflow surfaces.
- Source: Google Workspace Updates, March 25, 2026  
  <https://workspaceupdates.googleblog.com/2026/03/create-longer-musical-tracks-in-gemini-app-with-Lyria-3-Pro.html>

### 4) Google has now been pulled into music-training litigation too
...
### 5) Suno is still the clearest paid-scale signal in AI music
...
### 6) The recorded-music market remains large and growing, and fraud is now explicitly central
...
### 7) Music-specific copyright pressure is widening, not narrowing
...
### 8) The UK backed away from a creator-hostile default on AI training
...
### 9) Europe still has a live Suno test around output similarity
...
### 10) Sweden's STIM still matters because it shows licensing paths can exist
...
### 11) Real creator usage still skews toward assistive tools, not full-song generation
...
- Useful caveat: outside commentary noted the survey sample was partly drawn from an AI-tool ecosystem, so the headline adoption number should be treated as directional rather than universal.
- Source: Moises / Water & Music, March 2026  
  <https://moises.ai/insights/musician-ai-report-water-and-music/>

### 12) The distribution layer is dealing with large-scale impersonation and AI spam
